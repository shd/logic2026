...
\begin{frame}{}
\begin{center}{\Large Математическая логика}\\\itshape{КТ ИТМО, осень 2026 года}\end{center}
\end{frame}

\begin{frame}{Умеем ли мы правильно рассуждать?}
...
\flushright {\itshape А. Толстой. Золотой ключик или приключения Буратино}

%\flushleft А почему это неправильно?
\end{frame}
...
для задания языка, язык блок-схем и т.п.
\end{itemize}
