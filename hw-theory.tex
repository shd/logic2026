...
почему словесная интерпретация данной формулы действительно верна в булевой алгебре.
\item $\vdash (A \rightarrow B) \vee (B \rightarrow C) \vee (C \rightarrow A)$ --- дайте аналогичную предыдущему заданию ``неожиданную'' 
словесную интерпретацию этой формулы.
\end{enumerate}
...
\item возможно ли построить модель для КИВ (получив полную и корректную теорию), в которой множество истинностных значений $V$ имеет 
